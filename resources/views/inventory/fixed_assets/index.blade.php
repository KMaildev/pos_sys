        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mb-2">
                        <div class="col-sm-4">
                            <form action="{{ route('fixed_assets.index') }}" method="get" autocomplete="off">
                        ...
                        <div class="col-sm-8">
                            <div class="text-sm-end">
                                <a href="{{ route('fixed_assets.create') }}"
                                        ...
                                        <td class="text-center">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end" style="">
                                                    <li>
                                                        <a href="{{ route('fixed_assets.edit', $fixed_asset->id) }}"
                                                            class="dropdown-item">
                                                    ...
                                                    <li>
                                                        <form action="{{ route('fixed_assets.destroy', $fixed_asset->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
