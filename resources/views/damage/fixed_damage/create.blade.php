    ...
    <div class="row justify-content-center">
        <div class="col-xl-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('fixed_damage.store') }}" method="POST" autocomplete="off"
...
@endsection
@section('script')
    {!! JsValidator::formRequest('App\Http\Requests\StoreFixedDamage', '#create-form') !!}
@endsection
