            ...
            <div class="collapse navbar-collapse" id="topnav-menu-content">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle arrow-none" href="layouts-horizontal.html" id="topnav-dashboard" role="button">
                                            ...
                                            <div class="row g-0">
                                                ...
                                                <div class="col-lg-5">
                                                    <div>
                                                        ...
                                                        <a href="ui-utilities.html" class="dropdown-item" data-key="t-utility">Utilities <span class="badge rounded-pill bg-soft-danger text-danger float-end">New</span></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-pages">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-ecommerce">
                                    ...
                                    <a href="ecommerce-seller.html" class="dropdown-item" data-key="t-seller">Seller <span class="badge rounded-pill bg-soft-danger text-danger float-end">New</span></a>
                                    <a href="ecommerce-sale-details.html" class="dropdown-item" data-key="t-sale-details">Sale details <span class="badge rounded-pill bg-soft-danger text-danger float-end">New</span></a>
                                </div>
                            </div>
