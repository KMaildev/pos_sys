                        ...
                        <table class="table table-bordered mydatatable">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    {{-- Opening Unit	 --}}
                                    <td>
                                        <input type="text" id="OpeningUnit" class="form-control"
...
@section('script')
    ...
    <script>
        ...
        function SetCalculator() {
            var OpeningUnit = document.getElementById("OpeningUnit").value;
            var PricePerUnit = document.getElementById("PricePerUnit").value;
            var TotalStockValue = +OpeningUnit * +PricePerUnit;
        ...
        function addOpeningStock() {
            ...
            if (ingredientId == null || ingredientId == "") {
                ...
                return false;
            } else if (OpeningUnit == null || OpeningUnit == "" || isNaN(OpeningUnit)) {
            ...
            var url = '{{ url('stock_opening_entry') }}';
            $.ajaxSetup({
                headers: {
        ...
        function getopeningStockEntryAjax() {
            var url = '{{ url('get_stock_opening_entry') }}';
            $.ajax({
                url: url,
                method: "GET",
                success: function(data) {
                    ...
                    $.each(JSON.parse(data), function(key, value) {
                        ...
                        // Date
                        items += '<td>'
                        items += value.opening_date;
                        items += '</td>'

                        // Opening Unit	
                        items += '<td>'
                        items += value.opening_unit;
                        items += '</td>'
