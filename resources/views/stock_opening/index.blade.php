        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mb-2">
                        <div class="col-sm-4">
                            <form action="{{ route('stock_opening.index') }}" method="get" autocomplete="off">
                        ...
                        <div class="col-sm-8">
                            <div class="text-sm-end">
                                ...
                                <a href="{{ route('stock_opening.create') }}"
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-bordered mydatatable" id="tableId">
                            ...
                            <tbody>
                                @foreach ($stock_openings as $key => $stock_opening)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            {{ $stock_opening->opening_date ?? '' }}
                                        </td>

                                        <td class="text-center">
                                            {{ number_format($stock_opening->opening_unit, 2) }}
                                        </td>
                                        ...
                                        <td class="text-center">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end" style="">
                                                    <li>
                                                        <form
                                                            action="{{ route('stock_opening.destroy', $stock_opening->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    {{ number_format($stock_openings->sum('opening_unit'), 2) }}
                                </td>
